...
| [claude-code-review.yml](.github/workflows/claude-code-review.yml) | Pull Request | Optional automated code review on PRs using Claude (enable after installing the Claude Code GitHub App and setting `CLAUDE_CODE_REVIEW_ENABLED=true`) |
